...
function CreateNoteForm({ setNotes }) {
    ...
    return (
        <form onSubmit={handleNewNoteSubmit}>
            <input type="text" name="username" value={newNote.username} onChange={handleNewNoteChange} placeholder="Username" />
            <input type="text" name="title" value={newNote.title} onChange={handleNewNoteChange} placeholder="Title" />
            <textarea name="text" value={newNote.text} onChange={handleNewNoteChange} placeholder="Note" />
